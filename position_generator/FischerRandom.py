...
def htmlize(fischer_arrangement):
    """
    Converts the values within the list generated by fischerize() into html unicode. 

    Takes a singular list and outputs 2 lists that represent black and white unicode pieces. 
